...
import { PORT, CNX_STR } from './config.js';
...
await mongoose.connect(CNX_STR) //(MONGODB_CNX_STR)
  console.log(`Base de Datos Conectada "${CNX_STR}"`) //console.log(`Base de Datos Conectada "${MONGODB_CNX_STR}"`)
